...
- `ex-02-01-ab-comparison` → **2장 1절**, A/B 비교 실습
- 챕터/절은 두 자리 숫자로 0 패딩, 슬러그는 영문 kebab-case 로 작성합니다.

각 예제 폴더는 가능한 한 **독립적으로 실행 가능**하도록 구성되어 있습니다. 별도 의존성이 필요한 경우 해당 폴더의 README에 명시합니다.
